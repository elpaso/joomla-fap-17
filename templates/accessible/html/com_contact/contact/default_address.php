<?php
/** $Id: default_address.php 73 2008-09-17 09:52:52Z elpaso $ */
...
<tr>
	<td rowspan="6" valign="top" style="width:<?php echo $this->contact->params->get( 'column_width' ); ?>" >
...
<tr>
	<td style="width:<?php echo $this->contact->params->get( 'column_width' ); ?>" >
...
<table style="width:100%" cellpadding="0" cellspacing="0" border="0">
<tr>
	<td style="width:<?php echo $this->contact->params->get( 'column_width' ); ?>" valign="top" >
